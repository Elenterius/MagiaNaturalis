		...
		if(stack != null && stack.getItem() instanceof ItemWandCasting)
		{
			...
			if(focus != null && focus instanceof ItemFocusBuild)
			{
				...
				case 5:
					...
					FocusBuildHelper.setShape(focusStack, l > 4 ? Shape.NONE : FocusBuildHelper.getShapeByID(l));
					break;
				case 51:
					int q = FocusBuildHelper.getShape(focusStack).ordinal() - 1;
					FocusBuildHelper.setShape(focusStack, q < 0 ? Shape.SPHERE : FocusBuildHelper.getShapeByID(q));
					break;
				default:
