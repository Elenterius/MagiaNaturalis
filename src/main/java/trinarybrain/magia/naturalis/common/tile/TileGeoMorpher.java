	...
	{		
		...
		if(this.realCost.visSize() > 0)
		{
			...
			if((this.realCost.visSize() <= 0))
			{
				...
				this.worldObj.getChunkFromBlockCoords(posX, posY).setChunkModified();
				this.worldObj.markBlockRangeForRenderUpdate(this.xCoord, this.yCoord, this.zCoord, posX, posY, posZ);
