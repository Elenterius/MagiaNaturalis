...
public class Research
{
	...
	private static void initEntry() //TODO: Include Crafting Pages
	{
		...
		research.setPages(new ResearchPage[] { new ResearchPage("mn.research_page.ARCANE_CHEST.1") }).setParents("MN_WARDEDARCANA").registerResearchItem();
		...
		research.setPages(new ResearchPage("mn.research_page.FOCUS_BUILD.1")).setParents("MN_FOCUSTRADE").registerResearchItem();
		...
		research.setRound().setParents("MN_FOCUSTRADE" , "MN_CRUCIBLE").registerResearchItem();
		...
		research.setRound().setParents("MN_CRUCIBLE").registerResearchItem();
		...
		research.setRound().setParents("MN_FOCUSPOUCH").registerResearchItem();
