...
public final class ObfMapping
{
	...
	public final static String[] r_EntityLivingBase = {"sv", "net/minecraft/entity/EntityLivingBase"};
	public final static String[] m_isInvisible = {"ap", "isInvisible"};
	public final static String[] f_mainModel = {"i",  "mainModel"};
}
