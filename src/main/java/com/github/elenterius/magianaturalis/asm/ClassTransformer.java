        ...
        for (MethodNode method : classNode.methods) {
            if (method.name.equals(RENDER_MODEL) && method.desc.equals(RENDER_MODEL_DESC)) {
                ...
                if (targetNode != null) {
					...
					----TO THIS-----------------------------------------------------------------------------------------------------------------------------------------------------------------
					mv.visitMethodInsn(INVOKESTATIC, "trinarybrain/magia/naturalis/asm/MethodStub", "showInvisibleEntityToPlayer", "(Lnet/minecraft/entity/EntityLivingBase;)Z", false);
					Label l5 = new Label();
					...
					*/
                    ...
                    MethodInsnNode newNode = new MethodInsnNode(INVOKESTATIC, "com/github/elenterius/magianaturalis/asm/MethodStub", "showInvisibleEntityToPlayer", DESC, false);
