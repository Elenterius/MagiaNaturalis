...
public class RenderEvilTrunk extends RenderLiving {
    ...
    public static final ResourceLocation rlTC = MagiaNaturalis.rl( "textures/models/trunk_corrupted.png");
    public static final ResourceLocation rlTD = MagiaNaturalis.rl( "textures/models/trunk_demonic_wings.png");
    public static final ResourceLocation rlTS = MagiaNaturalis.rl( "textures/models/trunk_sinister.png");
    public static final ResourceLocation rlTT = MagiaNaturalis.rl( "textures/models/trunk_tainted.png");
