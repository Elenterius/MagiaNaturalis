...
public final class TileAccess {
     ...
     */
    public static boolean addPlayerToAccesList(EntityPlayer player, byte accessLevel, World world, int x, int y, int z) {
        byte result = TileAccess.addPlayerToAccesList(player.getGameProfile(), accessLevel, world, x, y, z);
        if (result-- > 0) {
