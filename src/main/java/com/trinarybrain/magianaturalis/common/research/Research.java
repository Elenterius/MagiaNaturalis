...
public class Research
{
	...
	private static void initEntry()
	{
		...
		research = new FakeResearchItem("MN_GOGGLES", Reference.ID, "GOGGLES", "ARTIFICE", -4, 1, ResearchCategories.getResearch("GOGGLES").icon_item).registerResearchItem();
		...
		research = new FakeResearchItem("MN_WARDEDARCANA", Reference.ID, "WARDEDARCANA", "ARTIFICE", -5, -2, ResearchCategories.getResearch("WARDEDARCANA").icon_item).registerResearchItem();

		research = new FakeResearchItem("MN_FOCUSTRADE", Reference.ID, "FOCUSTRADE", "THAUMATURGY", 2, -4, ResearchCategories.getResearch("FOCUSTRADE").icon_item).registerResearchItem();
		...
		research.setPages(new ResearchPage("mn.research_page.STONE_PHENO.1"), new ResearchPage((InfusionRecipe)Recipes.recipes.get("StonePheno")), new ResearchPage((IRecipe[])Recipes.recipes.get("WoodConversion")), new ResearchPage((IRecipe[])Recipes.recipes.get("ColorConversion")));
		research.setParents("MN_FOCUSTRADE" , "MN_CRUCIBLE").setSecondary().registerResearchItem();

		research = new FakeResearchItem("MN_CRUCIBLE", Reference.ID, "CRUCIBLE", "ALCHEMY", 3, -1, ResearchCategories.getResearch("CRUCIBLE").icon_item).registerResearchItem();
		...
		research.setPages(new ResearchPage("mn.research_page.STONE_QUICKSILVER.1"), new ResearchPage((InfusionRecipe)Recipes.recipes.get("StoneQuick"))).setParents("MN_CRUCIBLE").registerResearchItem();

		research = new FakeResearchItem("MN_FOCUSPOUCH", Reference.ID, "FOCUSPOUCH", "THAUMATURGY", 4, 2, ResearchCategories.getResearch("FOCUSPOUCH").icon_item).registerResearchItem();
		...
		research = new FakeResearchItem("MN_TRAVELTRUNK", Reference.ID, "TRAVELTRUNK", "GOLEMANCY", 1, 3, ResearchCategories.getResearch("TRAVELTRUNK").icon_item).registerResearchItem();
